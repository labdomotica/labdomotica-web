  ...
  return (
    <main className="min-h-screen flex flex-col justify-center items-center text-center px-6 bg-[#0F172A] text-[#F8FAFC]">
      ...
      <div className="flex gap-10">
        <a href="https://www.youtube.com/@labdomotica" target="_blank" rel="noopener noreferrer">
          <img src="/icons/youtube.svg" alt="YouTube" className="w-7 opacity-80 hover:opacity-100 transition" />
        </a>

        <a href="https://www.instagram.com/labdomotica" target="_blank" rel="noopener noreferrer">
          <img src="/icons/instagram.svg" alt="Instagram" className="w-7 opacity-80 hover:opacity-100 transition" />
        </a>

        <a href="mailto:contacto@labdomotica.com">
          <img src="/icons/email.svg" alt="Email" className="w-7 opacity-80 hover:opacity-100 transition" />
        </a>
      </div>
